...
% Put this somewhere in the evaluation
%While the generational algorithm claims to improve performance over a standard mark and sweep algorithm (given some assumptions about the data hold) I will not be comparing against the Boehm garbage collector for performance, the reasoning behind this is that their solution is a more mature piece of software with many platform-specific enhancements which would be hard to convincingly beat in the given timescale.
